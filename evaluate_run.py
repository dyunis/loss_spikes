...
def evaluate_run(cp_paths, train_loader, val_loader, model, sparsity=0.5):
    ...
    for path in tqdm(cp_paths):
        ...
        # - tfmr??
        # TODO: create a function that maps layer names to a list of pairs of input-output layers, will be bespoke per architecture
        ...
        for k1, k2 in pairs:
            ...
            if k1 == k2 and 'in_proj_weight' in k1:
                # TODO: do I need to split up the heads here?
                ...
                # TODO: qkv sim doesn't actually make sense as X is in the way...
                qkvsim = svdprod[2].matmul(svdv[0])
            ...
            if k1 == 'model.encoder.weight':
                U_prev = _svd1[2]  # embedding weight convention is reversed
