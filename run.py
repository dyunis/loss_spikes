...
def main(config, savedir):
    ...
    if config.perturb_epoch > -1:
        ...
        perturber = ModelPerturber(config.perturb_epoch, scale=config.perturb_scale, perturb_bottom_half=config.perturb_bottom_half, seed=config.seed)
    ...
    # TODO: one issue with this resuming is that it also resumes optimizer
