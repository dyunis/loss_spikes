...
# general args
parser.add_argument('--savedir', type=str, default='lmc_svd_run', help='savedir for checkpoints')
...
parser.add_argument('--cache_dir', type=str, default='/share/data/speech/Data/dyunis/data/lmc_svd', help='cache directory for data')
...
parser.add_argument('--perturb_bottom_half', action='store_true', default=False, help='if enable perturbs bottom half of svd as opposed to top half')
